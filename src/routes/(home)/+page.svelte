<h1 class="mx-4 mt-8 text-center text-3xl">Welcome to EzTripr</h1>
<div class="mx-8 my-10 grid grid-cols-1 gap-4 md:grid-cols-2">
	<div class="flex flex-col items-center p-4">
		<h2 class="mb-4 text-xl font-bold">Staff Portal</h2>
		<a
			href="/login"
	...
	<div class="flex flex-col items-center p-4">
		<h2 class="mb-4 text-xl font-bold">Join The Team</h2>
		<a
			href="/apply"
